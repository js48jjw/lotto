...
export default function VaporizeTextCycle({
  ...
  }, [fontConfig.MULTIPLIED_VAPORIZE_SPREAD, animationDurations.VAPORIZE_DURATION, direction]);
  ...
  }, [animationState, isInView, texts, direction, globalDpr, memoizedUpdateParticles, memoizedRenderParticles, animationDurations.FADE_IN_DURATION, animationDurations.WAIT_DURATION, animationDurations.VAPORIZE_DURATION, alignment, color, currentTextIndex, font]);
  ...
  particles.forEach(particle => {
    ...
    if (shouldVaporize) {
      ...
      if (particle.speed === 0) {
        ...
        particle.shouldFadeQuickly = Math.random() > 0.5;
      }
